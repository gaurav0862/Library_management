...
class viewsec:
     ...
     def __init__(self):
                ...
                self.top.label_3 = Label(self.top, text="Sections",font=("Constantia", "25", "italic", 'bold')).pack(side=TOP,pady=20)
                self.top.label4 = Label(self.top, text="Double click to delete value", font=("Constantia", "10", 'bold')).pack(side="bottom", pady=20)
                self.top.waraper = LabelFrame(self.top,text="Sections Details")
                ...
                self.trv.heading(1, text="Sections")
                self.trv.heading(2, text="Section Description")
